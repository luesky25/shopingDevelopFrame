 ...
 */
public class PutJsonStringBuilder extends OkHttpRequestBuilder<PutJsonStringBuilder> implements HasParamsable {
    private boolean hasToken;
    private boolean dateline;


    @Override
    public PutJsonStringBuilder params(Map<String, String> params) {
        this.params = params;
        return this;
    }

    @Override
    public PutJsonStringBuilder addParams(String key, String val) {
        if (this.params == null) {
    ...
    @Override
    public PutJsonStringBuilder token() {
        hasToken = true;
        return this;
    }

    @Override
    public PutJsonStringBuilder dateline() {
        dateline = true;
        return this;
    }
    ...
    public RequestCall build() {
        ...
        OtherRequest request = new OtherRequest(null, new JSONObject(params).toString(), OkHttpUtils.METHOD.PUT, url, tag, params, headers, id);
