...
public abstract class BaseImage implements IImage {
    ...
    protected BaseImage(BaseImageList container, ContentResolver cr, long id, int index, Uri uri,
                        String dataPath, long miniThumbMagic, String mimeType, long dateTaken, String title,
                        String displayName) {
    ...
    private void setupDimension() {
        ...
        try {
            ...
            Bitmap b = BitmapManager.instance().decodeFileDescriptor(input.getFileDescriptor(),
                    options);
            if (b != null) {
                b.recycle();
            }
	...
	public Bitmap miniThumbBitmap() {
        ...
        try {
            long id = mId;
            b = Images.Thumbnails.getThumbnail(mContentResolver, id, Images.Thumbnails.MICRO_KIND,
                    null);
        } catch (Throwable ex) {
