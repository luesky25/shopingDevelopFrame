 ...
 *
 * @author ldx
 * @since 2013-12-12 上午11:47:26
 */
public abstract class BaseContentProvider extends ContentProvider {

	public static String AUTHORITY = "colorringtonedb";
	 ...
	 * @param newVersion
	 */
	protected abstract void onDatabaseUpgrade(SQLiteDatabase db,
											  int oldVersion, int newVersion);

	private class DatabaseHelper extends SQLiteOpenHelper {

		public DatabaseHelper(Context context) {
			super(context, BaseContentProvider.this.getDatabaseName(), null,
					getDatabaseVersion());
			// super(context, "asa.db", null, 32);
		}
